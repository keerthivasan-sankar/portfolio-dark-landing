...
export default function ContactFooter() {
  ...
  // HLS video for footer (flipped vertically)
  useEffect(() => {
  ...
  return (
    <section id="contact" className="relative bg-bg pt-16 md:pt-20 pb-8 md:pb-12 overflow-hidden">
      ...
      <div className="relative z-10 overflow-hidden py-8 md:py-12">
        <div ref={marqueeRef} className="whitespace-nowrap text-4xl md:text-6xl lg:text-7xl font-display text-text-primary/10">
          {marqueeText}
        </div>
      </div>
      ...
      <div className="relative z-10 text-center px-6 mb-16">
        <h2 className="text-3xl md:text-4xl lg:text-5xl text-text-primary mb-6">
          Let&apos;s <span className="font-display italic">create</span> something together
        </h2>
        <a
          href="mailto:kkeerthivasan811@gmail.com"
          className="inline-flex items-center gap-2 rounded-full text-sm px-7 py-3.5 border-2 border-stroke bg-bg text-text-primary hover:border-transparent transition-all duration-300 gradient-border-ring"
        >
